...
| Tool | What it does |
|---|---|
| [Project Scanner](https://spklab.org/scanner/) | See which third-party plugins & fonts an `.aep` / `.prproj` project needs — before opening it · 플러그인·폰트 검사기 |
| [Version Changer](https://spklab.org/convert/) | Open newer After Effects / Premiere Pro projects in older versions (downgrade `.aep` / `.prproj`) · 버전 변환기 |
